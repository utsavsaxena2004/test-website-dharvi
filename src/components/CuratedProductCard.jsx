  ...
  return (
    <>
      ...
      >
        ...
        <div className="p-4">
          {/* Product Name */}
          <h3 className="font-medium text-gray-900 text-sm mb-1 line-clamp-2 group-hover:text-[#6f0e06] transition-colors duration-200">
            {product.name}
          </h3>
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <span className="text-lg font-bold text-[#6f0e06]">
          ...
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              className={`flex-1 py-2 text-xs font-medium rounded transition-colors duration-200 flex items-center justify-center gap-1 ${
                isOutOfStock 
