    ...
    <div className="fixed top-6 right-6 z-[9999] space-y-3 max-w-sm w-full">
      {toasts.map((toast) => (
        <div
          key={toast.id}
          className={`
            w-full bg-white shadow-xl rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-10 transform transition-all duration-300 ease-in-out
...
// Add the slideInRight animation styles
