...
const FlowerPattern = () => (
  <svg width="60" height="60" viewBox="0 0 60 60" className="text-[#6f0e06] opacity-10">
    <g>
...
const WavePattern = ({ className }) => (
  <svg viewBox="0 0 200 20" className={`${className} text-[#6f0e06] opacity-15`}>
...
const CornerPattern = () => (
  <svg width="40" height="40" viewBox="0 0 40 40" className="text-[#6f0e06] opacity-20">
...
const StarPattern = () => (
  <svg width="70" height="70" viewBox="0 0 70 70" className="text-[#6f0e06] opacity-15">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-16">
          <div>
            ...
            >
              <div className="flex items-center space-x-3 mb-2">
                ...
                <span className="text-[#6f0e06] font-medium text-sm uppercase tracking-wide">Modern Grace</span>
              </div>
            </motion.div>
          ...
          >
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center px-6 py-2.5 text-sm border border-[#6f0e06] text-[#6f0e06] hover:bg-[#6f0e06] hover:text-white transition-all duration-300 rounded-md group"
            >
        ...
        >
          <motion.div className="text-center">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="relative inline-flex items-center px-8 py-3 border border-[#6f0e06] text-[#6f0e06] hover:bg-[#6f0e06] hover:text-white transition-all duration-300 rounded-md group overflow-hidden"
            >
              ...
              {/* Button animation */}
              <div className="absolute inset-0 bg-[#6f0e06] transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300 z-0"></div>
            </motion.a>
