...
const Navbar = () => {
  ...
  const navigation = [
    ...
    { name: 'Lehanga', href: '/noodle-strap-kurtis', hasSubmenu: false },
    { name: 'Shop By Category', href: '/shop', hasSubmenu: true },
    { name: 'About Us', href: '/about', hasSubmenu: false },
    { name: 'Contact Us', href: '/contact', hasSubmenu: true },
  ];
          ...
          <div className="hidden md:block">
            <ul className="flex justify-center space-x-8">
              ...
              <li className="group relative px-3 py-2">
                <Link to="/wishlist" className="text-gray-800 hover:text-[#6f0e06] transition-colors duration-300 flex items-center">
                  <span>Wishlist</span>
