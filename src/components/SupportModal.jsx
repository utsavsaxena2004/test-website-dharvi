            ...
            <div className="space-y-6 text-sm leading-relaxed">
              <div className="bg-primary/5 rounded-lg p-4 border border-primary/20">
                <div className="space-y-2">
                  <p className="font-semibold text-foreground">Effective Date: 10 July 2025</p>
                  <p className="font-semibold text-foreground">Platform: www.dharika.co.in</p>
                  <p className="font-semibold text-foreground">Brand Name: Dharika</p>
                  <p className="font-semibold text-foreground">Tagline: हम से आप तक</p>
                </div>
              </div>

              <div className="text-foreground/80">
                <p className="mb-4">
                  These Terms of Service ("Terms") govern your use of the website operated by Dharika, including all information, tools, and services available through the Platform. By accessing, browsing, or making a purchase from www.dharika.co.in, you agree to be legally bound by these Terms and all applicable laws and regulations of India.
                </p>
                <p className="mb-6">
              ...
              <div className="space-y-6">
                <section>
                  <h4 className="font-semibold text-foreground mb-3">1. Eligibility & Access</h4>
                  <div className="text-foreground/80 space-y-3">
                    <p>
                      By using the Platform, you affirm that you are at least 18 years of age or are accessing the website under the supervision of a parent or legal guardian. Dharika's services are intended solely for personal, non-commercial use.
                    </p>
                    <p>
                      We reserve the right to refuse service or cancel orders at our discretion, including but not limited to suspected fraud, policy violations, or misuse of services.
                    </p>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">2. Account Registration & Responsibilities</h4>
                  <div className="text-foreground/80 space-y-3">
                    <p>Users may be required to create an account to make purchases or access certain features. You agree to:</p>
                    ...
                    <p>
                      We reserve the right to suspend or terminate accounts found to be in violation of our policies, or for any unauthorized or unlawful activity.
                    </p>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">3. Products, Descriptions & Availability</h4>
                  <div className="text-foreground/80 space-y-3">
                    <p>All products listed on our Platform are made-to-order and crafted with attention to detail. While we make every effort to display product details, colors, and measurements accurately:</p>
                    <ul className="ml-4 space-y-1">
                      <li>• Slight variations may occur due to lighting, photography, screen settings, or hand-crafted nature;</li>
                      <li>• Product availability may change without prior notice;</li>
                      <li>• We reserve the right to limit quantities and discontinue products at our discretion.</li>
                    </ul>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">4. Pricing, Payment & Billing</h4>
                  <div className="text-foreground/80 space-y-3">
                    <p>All prices are stated in Indian Rupees (INR) and are inclusive of applicable shipping charges. We accept secure payment through trusted gateways via:</p>
                    <ul className="ml-4 space-y-1">
                      <li>• UPI</li>
                    ...
                    <p>Orders are processed only upon successful payment confirmation. Dharika reserves the right to cancel any order due to payment failure, price discrepancy, or suspicion of unlawful activity.</p>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">5. Shipping, Delivery & Timeline</h4>
                  <div className="text-foreground/80 space-y-3">
                    <p>Shipping timelines range from 7 to 15 working days, depending on the product and your delivery PIN code. While we strive to ensure timely delivery, Dharika shall not be held liable for delays due to:</p>
                    <ul className="ml-4 space-y-1">
                      <li>• Courier disruptions</li>
                      <li>• Natural calamities</li>
                      <li>• Regional lockdowns or other force majeure conditions</li>
                    </ul>
                    <p>Tracking information will be shared post-dispatch via email or SMS.</p>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">6. Returns, Exchanges & Claims</h4>
                  <div className="text-foreground/80 space-y-3">
                    <p>Dharika follows a strict return and exchange policy in line with the handcrafted and limited-edition nature of our products.</p>
                    <ul className="ml-4 space-y-1">
                      <li>• Returns are only accepted in cases of damaged, defective, or incorrect items received.</li>
                      <li>• Exchanges for sizing issues are allowed once per product, if requested within 7 days of delivery.</li>
                      <li>• The item must be unused, in original condition with tags and packaging intact.</li>
                      <li>• A clear parcel opening video showing the issue must be submitted to support your claim.</li>
                    </ul>
                    <p>All decisions made by Dharika's Quality Control team regarding return/exchange eligibility shall be final. We reserve the right to deny exchanges that do not meet our criteria.</p>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">7. Intellectual Property</h4>
                  <div className="text-foreground/80">
                    <p>All content on the Platform, including images, designs, text, artwork, logos, and brand assets, is the sole property of Dharika. Unauthorized copying, distribution, or reproduction of our content for commercial or personal purposes is strictly prohibited without prior written consent.</p>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">8. User Conduct & Prohibited Use</h4>
                  <div className="text-foreground/80 space-y-3">
                    <p>Users shall not use the Platform to:</p>
                    <ul className="ml-4 space-y-1">
                      <li>• Engage in illegal or fraudulent activity</li>
                      <li>• Interfere with security-related features</li>
                      <li>• Upload malicious code, spam, or unsolicited advertising</li>
                      <li>• Violate the intellectual property or privacy rights of others</li>
                    </ul>
                    <p>Violation of this clause may result in immediate termination of access and legal action.</p>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">9. Third-Party Services & Links</h4>
                  <div className="text-foreground/80">
                    <p>The Platform may contain links to third-party websites or tools. Dharika does not endorse or assume responsibility for the content, practices, or policies of third-party platforms. Your engagement with such platforms is at your own risk and subject to their respective terms.</p>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">10. Limitation of Liability</h4>
                  <div className="text-foreground/80 space-y-3">
                    <p>To the fullest extent permitted under applicable law, Dharika, its founders, affiliates, and vendors shall not be liable for:</p>
                    <ul className="ml-4 space-y-1">
                      <li>• Any indirect, incidental, or consequential damages</li>
                      <li>• Delays or failures caused by circumstances beyond reasonable control</li>
                      <li>• Loss of data, profits, or goodwill arising out of the use or inability to use the Platform</li>
                    </ul>
                    <p>Your sole remedy for dissatisfaction is to discontinue use of the Platform.</p>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">11. Data & Privacy</h4>
                  <div className="text-foreground/80">
                    <p>Your personal information is collected, stored, and processed in accordance with our Privacy Policy, in compliance with the Digital Personal Data Protection Act, 2023, and other applicable Indian IT laws.</p>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">12. Modifications to Terms</h4>
                  <div className="text-foreground/80">
                    <p>We reserve the right to revise or update these Terms at any time. Any changes will be posted on this page, with the "Effective Date" updated accordingly. Continued use of the Platform after modifications constitutes your binding acceptance of such changes.</p>
                  </div>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">13. Governing Law & Jurisdiction</h4>
                  <div className="text-foreground/80 space-y-3">
                    <p>These Terms shall be governed and construed in accordance with the laws of India. Any disputes arising shall be subject to exclusive jurisdiction of the competent courts at Haryana.</p>
                    <p>All disputes, if any, shall be resolved by arbitration under the Arbitration and Conciliation Act, 1996, with the seat of arbitration being the aforementioned city.</p>
                  </div>
                </section>
