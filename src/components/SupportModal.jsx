        ...
        return {
          ...
          content: (
            <div className="space-y-6 text-sm leading-relaxed">
              <div className="bg-primary/5 rounded-lg p-4 border border-primary/20">
                <p className="font-semibold text-foreground mb-2">Effective Date: 10 July 2025</p>
                <p className="font-medium text-foreground mb-1">Platform: www.dharika.co.in</p>
                <p className="font-medium text-foreground mb-1">Brand Name: Dharika</p>
                <p className="font-medium text-foreground mb-3">Tagline: हम से आप तक</p>
                <p className="text-foreground/80">
              ...
              <div className="space-y-6">
                ...
                <section>
                  ...
                  <p className="text-foreground/80 mb-3">
                    Users may be required to create an account to make purchases or access certain features. You agree to:
                  </p>
                ...
                <section>
                  ...
                  <p className="text-foreground/80 mb-3">
                    All products listed on our Platform are made-to-order and crafted with attention to detail. While we make every effort to display product details, colors, and measurements accurately:
                  </p>
                  <ul className="space-y-2 text-foreground/80 ml-4">
                ...
                <section>
                  ...
                  <p className="text-foreground/80 mb-3">
                    All prices are stated in Indian Rupees (INR) and are inclusive of applicable shipping charges. We accept secure payment through trusted gateways via:
                  </p>
                  <ul className="space-y-1 text-foreground/80 ml-4">
                    <li>• UPI</li>
                  ...
                  <p className="text-foreground/80 mt-3">
                    Orders are processed only upon successful payment confirmation. Dharika reserves the right to cancel any order due to payment failure, price discrepancy, or suspicion of unlawful activity.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-foreground/80 mb-3">
                    Shipping timelines range from 7 to 15 working days, depending on the product and your delivery PIN code. While we strive to ensure timely delivery, Dharika shall not be held liable for delays due to:
                  </p>
                  <ul className="space-y-1 text-foreground/80 ml-4">
                  ...
                  <p className="text-foreground/80 mt-3">
                    Tracking information will be shared post-dispatch via email or SMS.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-foreground/80 mb-3">
                    Dharika follows a strict return and exchange policy in line with the handcrafted and limited-edition nature of our products.
                  </p>
                  <ul className="space-y-2 text-foreground/80 ml-4">
                  ...
                  <p className="text-foreground/80 mt-3">
                    All decisions made by Dharika's Quality Control team regarding return/exchange eligibility shall be final. We reserve the right to deny exchanges that do not meet our criteria.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-foreground/80">
                    All content on the Platform, including images, designs, text, artwork, logos, and brand assets, is the sole property of Dharika. Unauthorized copying, distribution, or reproduction of our content for commercial or personal purposes is strictly prohibited without prior written consent.
                  </p>
                </section>

                <section>
                  <h4 className="font-semibold text-foreground mb-3">8. User Conduct & Prohibited Use</h4>
                  <p className="text-foreground/80 mb-3">Users shall not use the Platform to:</p>
                  <ul className="space-y-1 text-foreground/80 ml-4">
                ...
                <section>
                  ...
                  <p className="text-foreground/80">
                    The Platform may contain links to third-party websites or tools. Dharika does not endorse or assume responsibility for the content, practices, or policies of third-party platforms. Your engagement with such platforms is at your own risk and subject to their respective terms.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-foreground/80 mb-3">
                    To the fullest extent permitted under applicable law, Dharika, its founders, affiliates, and vendors shall not be liable for:
                  </p>
                  <ul className="space-y-1 text-foreground/80 ml-4">
                ...
                <section>
                  ...
                  <p className="text-foreground/80">
                    Your personal information is collected, stored, and processed in accordance with our Privacy Policy, in compliance with the Digital Personal Data Protection Act, 2023, and other applicable Indian IT laws.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-foreground/80">
                    We reserve the right to revise or update these Terms at any time. Any changes will be posted on this page, with the "Effective Date" updated accordingly. Continued use of the Platform after modifications constitutes your binding acceptance of such changes.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-foreground/80 mb-3">
                    These Terms shall be governed and construed in accordance with the laws of India. Any disputes arising shall be subject to exclusive jurisdiction of the competent courts at Haryana.
                  </p>
                  <p className="text-foreground/80">
                    All disputes, if any, shall be resolved by arbitration under the Arbitration and Conciliation Act, 1996, with the seat of arbitration being the aforementioned city.
                  </p>
                </section>
